...
<div class="panel-group">
	...
	<div class="panel-body table-responsive">
				...
				<input type="email" name="email" id="emailField" value="${user.emailId}" disabled required title="Enter a valid email address"/></td>
				<tr><th>Name</th><td>
				...
				<input type="text" name="contact" id="mobileField" value="${user.contact}" disabled required pattern="[0-9]{10}" title="Enter a 10 digit mobile number" maxlength="10"/></td>
