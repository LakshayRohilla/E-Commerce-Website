			...
			<div class="checkout-left">	
				<div class="checkout-left-basket animated wow slideInLeft" data-wow-delay=".5s">
					...
					<c:forEach var="p" varStatus="s" items="${cartInfo}">
						...
						<li>Product ${s.index+1 } <i>-</i> <span>$<i class="fa fa-inr"></i> <c:out value="${p.cartStock*p.cartPrice }"></c:out> </span></li>
				...
				<c:if test="${empty cartInfo!=true }">
					<div class="checkout-right-basket animated wow slideInRight" data-wow-delay=".5s">
						<a href="${pageContext.request.contextPath }/allProducts"><span class="glyphicon glyphicon-menu-left" aria-hidden="true"></span>Continue Shopping</a>
					</div>
					<div class="checkout-right-basket animated wow slideInRight" data-wow-delay=".5s">
